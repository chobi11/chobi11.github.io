        ...
        <tr>
            <td>
                <div>
                    ...
                    ` : ''}
                    ${(localStorage.getItem("col") != 1  && localStorage.getItem("token")!=undefined)? `<a class="subopt" onclick="ds('a');hidephnopt();">mix</a>&nbsp;&nbsp;&nbsp;&nbsp;` : ''}
                    ${(localStorage.getItem("col") != 2 && localStorage.getItem("token")!=undefined) ? `<a class="subopt" onclick="ds('d');hidephnopt();">desi</a>&nbsp;&nbsp;&nbsp;&nbsp;` : ''}
                    ${(localStorage.getItem("col") != 3 && localStorage.getItem("token")!=undefined) ? `<a class="subopt" onclick="ds('f');hidephnopt();">foreign</a>` : ''}
                </div>
            </td>
        </tr>
        ${big == 1 ? `
...
// Check if the browser supports Page Visibility API
